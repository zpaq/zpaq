#   zpaq.pod - zpaq v7.00 man page source
#
#   Copyright
#
...
I<zpaq> v7.00 is copyright (C) 2009-2015, Dell Inc. It is written by Matt
...
I<zpaq> includes code from I<libzpaq> v7.00. I<libzpaq> includes code from
I<libdivsufsort-lite> v2.01, copyright (C) 2003-2008,
Yuta Mori. It is licensed under the MIT license. See the source
code for license text. The remainder of I<libzpaq> is public domain.
The AES code is modified from libtomcrypt by Tom St Denis.
The salsa20/8 code in Scrypt() is by D. J. Bernstein.
The remaining code is written by Matt Mahoney.
