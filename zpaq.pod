#   zpaq.pod - zpaq v7.08 man page source
#
#   Copyright
#
...
no compressed data. Thus, it takes much less space but files cannot
be extracted. It is an error to update a regular archive
