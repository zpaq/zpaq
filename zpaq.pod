#   zpaq.pod - zpaq v7.10 man page source
#
#   Copyright
#
...
It is an error if the I<archive> to be created already exists, or if
I<indexfile> is a regular archive. C<-index> cannot be used with
C<-until> or a streaming archive C<-method s...>.
