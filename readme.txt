zpaq636.zip, July 5, 2013. Contents:

zpaq.exe      6.36   Archiver, 32 bit Windows command line executable.
zpaq64.exe    6.36   For 64 bit Windows.
zpaq.cpp      6.36   zpaq user's guide and source code.
