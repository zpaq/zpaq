zpaq635.zip, June 28, 2013. Contents:

zpaq.exe      6.35   Archiver, 32 bit Windows command line executable.
zpaq64.exe    6.35   For 64 bit Windows.
zpaq.cpp      6.35   zpaq user's guide and source code.
